...
cred = credentials.Certificate('face-detection-project-73a1c-firebase-adminsdk-15iqc-77995e76e5.json')
...
# Face detected but Lips not detected which means person is wearing mask
        if(len(mouth_rects) == 0):
            ...
            for (mx, my, mw, mh) in mouth_rects:
                ...
                if(y < my < y + h):
 # Face and Lips are detected but lips coordinates are within face coordinates which `means lips prediction is true and # person is not wearing mask
